...
?>
    ...
    <div class="row">
        ...
        if ($_SESSION['type'] == 'admin') {
            ...
            <div class="col-md-3">
                <div class="panel panel-default">
                    <div class="panel-heading"><strong>Total User Roles</strong></div>
                    <div class="panel-body">
                        <h1><?php echo count_total_user_roles($connect); ?></h1>
                    </div>
                </div>
            </div>
            <?php
        ...
        if ($_SESSION['type'] !== 'admin') {
            ...
            <div class="col-md-3">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <h1><?php echo count_total_avilable_services($connect, $_SESSION['type']); ?></h1>
                    </div>
                </div>
            </div>
            <?php
